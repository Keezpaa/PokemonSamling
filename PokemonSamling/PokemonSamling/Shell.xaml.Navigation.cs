...
using PokemonSamling.Services;
using PokemonSamling.Views;
using System;
...
namespace PokemonSamling
{
    public sealed partial class Shell : INavigation
    {
        private void NavigationView_Loaded(object sender, RoutedEventArgs e)
        {
            SetCurrentNavigationViewItem(GetNavigationViewItems(typeof(PokemonPage)).First());
        }
